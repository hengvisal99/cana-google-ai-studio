            ...
            <div>
              ...
              <div className="space-y-1.5">
                ...
                <button
                  ...
                  className={cn(
                    'w-full flex items-center justify-between px-3.5 py-3 rounded-2xl font-bold transition-all duration-200',
                ...
                >
                  ...
                  {!sidebarCollapsed && (
                    <span className={cn(
                      ...
                      currentPage === 'customer-360' ? 'bg-white/20 text-white' : 'bg-blue-100 text-blue-800'
                    )}>
                      360°
                    </span>
                  )}
