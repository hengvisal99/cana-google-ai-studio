...
export function AuroraShell({
  ...
  return (
    <div id="aurora-layout" className="min-h-screen bg-[#F0F4F8] text-slate-900 flex flex-col antialiased">
      ...
      >
        {/* Left: Brand Badge + Sidebar Toggle + Title */}
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-gradient-to-r from-blue-600 to-indigo-600 text-white uppercase tracking-wider">
                Aurora
              </span>
