...
/**
 * Plain filter select with its label inside the box ("Gender: All"). Looks the same
 * whether or not a value is chosen; the menu lists "All" first, then the options.
 */
          ...
          {items.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex w-full cursor-pointer items-center rounded-lg px-3 py-2 text-left text-xs transition',
