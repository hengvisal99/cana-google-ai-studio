...
import { BTN_GHOST, DialogShell, customerName } from './CustomerTypeForm';
 ...
 */
export function CustomerTypePickerDialog({ individual, onClose, onSaveRecord }: CustomerTypePickerDialogProps) {
  ...
  return (
    <DialogShell
      ...
      subtitle={
        <>
          <span className="font-mono">{individual.customerId || individual.id}</span> • {customerName(individual)}
        </>
      }
      onClose={onClose}
      footer={
    ...
    >
      <p className="mb-3 text-xs text-slate-500">Select the customer type you want to add for this customer.</p>
        ...
        {CUSTOMER_TYPES.map((type) => {
          ...
          return (
            <button
              ...
              className="group flex items-start gap-3 rounded-xl border border-slate-200 bg-white p-3.5 text-left transition hover:border-blue-300 hover:bg-blue-50/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-100"
            >
